...
- 2 mid-tier (500K–5M): `#IndianOOTD`, `#DesiStyle`, `#ethnicwear`
- 1 broad anchor: `#ootd`
- Never use tags with 1B+ posts (#fashion, #style) — impossible to surface there
- Hashtags are now classification signals, not traffic drivers — they tell Instagram what category to test your content in

**Caption format:**
```
[1-2 sentence hook — personal, minimal, no AI tell]
...
Reel specs:
- Under 60 seconds performs best for reach
- Hook in first 3 seconds — no slow intros
- Max 3 min allowed but 30–60s is the sweet spot

For Ananya: OOTD Reel = quick outfit transition, walking shot, or mirror reveal. Not a static slideshow.
...
2. Share link to WhatsApp contacts / groups
...
| Category | Tags |
|----------|------|
| Ethnic/kurta | `#chikankari` `#ethnicwear` `#indiankurta` `#kurtalove` |
