...
WORKFLOW_SENTINELS = {
    ...
    "flux_img2img_controlnet": ["_claude_inject_prompt", "_claude_inject_seed", "_claude_inject_init_image", "_claude_inject_controlnet", "_claude_inject_pose_image", "_claude_inject_skin_lora"],
